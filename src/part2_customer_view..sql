-- Создание таблицы segment_table
...
CALL import('segment_table', '/Users/changeli/goinfre/SQL_3/datasets/Segment_table.csv', ',');
...
SELECT customer_id, Customer_Average_Check, Customer_Average_Check_Segment,
       Customer_Frequency, Customer_Frequency_Segment, Customer_Inactive_Period,
       Customer_Churn_Rate, Customer_Churn_Segment, segment_table.Segment AS Customer_Segment,
       Customer_Primary_Store
FROM full_table
LEFT JOIN segment_table ON full_table.Customer_Average_Check_Segment = segment_table.Average_check AND
                           full_table.Customer_Frequency_Segment = segment_table.Frequency_of_purchases AND
                           full_table.Customer_Churn_Segment = segment_table.Churn_probability
